...
var OptionContext = /** @class */ (function () {
  ...
  OptionContext.prototype.optionEnter = function (key) {
    ...
    this.setState(
      ((_a = {}),
      (_a[key] = __assign(__assign({}, optionState), {
  ...
  OptionContext.prototype.setValue = function (key, value) {
    for (
      var _i = 0, _a = Array.from(this.valueChangeListeners);
      _i < _a.length;
      _i++
    ) {
      var listener = _a[_i]
  ...
  OptionContext.prototype.setOptions = function (key, options) {
    ...
    this.setState(
      ((_a = {}),
      (_a[key] = __assign(__assign({}, this.state[key]), {
        key: key,
        options: options,
      })),
      _a)
  ...
  OptionContext.prototype.notifyListener = function () {
    for (
      var _i = 0, _a = Array.from(this.stateChangeListeners);
      _i < _a.length;
      _i++
    ) {
      var listener = _a[_i]
...
exports.AvatarContext = react_1.createContext(new OptionContext([]))
